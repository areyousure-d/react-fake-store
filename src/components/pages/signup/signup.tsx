...
const Signup: FC = () => {
  ...
  const onSignup = (data: SignupDataType) => {
    ...
    auth
      ...
      .catch((err: { message: string }) =>
        dispatch(userSignupError(err.message))
      );
  };
  ...
  return (
    <form onSubmit={handleSubmit(onSignup)} className={styles.signup}>
      ...
      <div className={styles.inputs}>
        ...
        />
        {errors.email && (
          <div className={styles.validationError}>Емеил обязателен</div>
        )}
        <input
          name="pass"
          type="password"
        ...
        {errors.pass && errors.pass.type === "required" && (
          <div className={styles.validationError}>Пароль обязателен</div>
        )}
        {errors.pass && errors.pass.type === "minLength" && (
          <div className={styles.validationError}>Пароль слишком короткий</div>
        )}
        {errors.pass && errors.pass.type === "maxLength" && (
          <div className={styles.validationError}>Пароль слишком длинный</div>
        )}
        <input
          name="passConfirm"
          type="password"
        ...
        {!isPasswordsEqual && (
          <div className={styles.validationError}>Пароли не совпадают</div>
        )}
